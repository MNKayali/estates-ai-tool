...
`/api/rates-check` must confirm **both** workbooks load: `ratesOk` + a sample rate, and `programmeOk` + a sample duration (e.g. DS2 S3 mid). Use it after every workbook edit.
