      ...
      <div className="no-print" style={{ maxWidth: '880px', margin: '0 auto', padding: '0 16px' }}>
        {sample && (
          <div role="status" style={{ ...alertStyle('#FFF8E8', '#C4861A'), marginTop: '12px' }}>
            <strong>This is a sample.</strong> A fictional project, generated by the tool exactly as your own report would be: every figure from the NRM1 and programme workbooks, and the written sections built around those fixed figures. Numbers are illustrative only.
          </div>
        )}
        {isPending && (
