...
import {
  ...
  VerticalAlign, HeightRule, LevelFormat, PageNumber, TableLayoutType,
} from 'docx'
...
export function t(text, { size = TYPE.body, color = COLOURS.ink, semi = false, mono = false, italic = false, fill } = {}) {
  return new TextRun({
    text: clean(text),
