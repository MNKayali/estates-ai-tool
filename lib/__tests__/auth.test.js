...
describe('who may see a report', () => {
  ...
  it('a pre-account report (no owner) stays open to any signed-in user', () => {
    expect(canViewReport(other, {})).toBe(true)
    expect(canViewReport(null, {})).toBe(false)
  })

  it('answers 404, not 403, for someone else’s report', async () => {
