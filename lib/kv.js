 ...
 *
 * Reports expire after 90 days (7,776,000 seconds) once complete.
 *
 ...
 *      (now including aiProse + docx), status 'complete', re-stamped to the
 *      full 90-day TTL, and only now pushed onto the admin index — so a report
...
/**
 * Write the final, complete record (aiProse + docx included), re-stamp it to
 * the full 90-day TTL, push it onto the admin index for the first time, and
 * clean up the now-redundant sidecar keys and locks.
 */
