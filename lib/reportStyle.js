...
// "Estates AI" is a placeholder name; the contact values are placeholders
// until real ones are supplied. Changing them here changes every page of
// every output.
...
export const FONTS = Object.freeze({
  ...
  word: Object.freeze({ regular: 'IBM Plex Sans', semibold: 'IBM Plex Sans SemiBold', mono: 'IBM Plex Mono' }),
})
