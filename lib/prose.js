  ...
  const narrativeGuidance = `Populate the tool arguments following this field guidance:
{
  ...
  "costNarrative": "3 to 4 sentences, about four printed lines, placed directly above the works cost table: explain what drives the works cost for this project. Do not quote any number — the numbers are in the table.",
