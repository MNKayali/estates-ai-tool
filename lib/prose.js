...
Specification level: ${cost.specLevel} | Level of intervention: ${cost.interventionLevel || 'Not applicable (not asked for this project type)'}${cost.constructionMethod === 'Modular' ? ' | Construction method: Modular' : ''}
