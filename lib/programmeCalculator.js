...
export async function calculateProgramme(answers, costMidpoint) {
  ...
  // ── Design duration multiplier from Q2.3 (v6 option names) ──────────────
  const designMultiplierMap = {
    'Like-for-like replacement': 0.5,  // minimal design only
    'Light touch':               0.7,
    'Refurbishment':             1.0,
    'Strip-out and rebuild':     1.3,
  }
  ...
  if (fundingSource === 'Grant or public funding') {
    ...
    stages.push({ stage: 'Governance', activity: 'Grant governance approval', durationWks: grantGovernanceWks, notes: procurementNote })
  }
